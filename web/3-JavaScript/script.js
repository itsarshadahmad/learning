...
// Get String length
const str1 = "This will get string length counting each character";
console.log(str1.length);

// Change string to upper cased
const str2 = "this will be upper cased";
console.log(str2.toUpperCase());

// Change string to lower cased
const str3 = "THIS WILL BE LOWER CASED";
...
const arr2 = ["Mathiew", "Shane", "Sean", "Andriew", "Greg", "Shida"];
const result = arr2.find((item) => item === "Sean");
console.log(result);

// findIndex --> It finds index of searched item and also iterates
const arr3 = ["Mathiew", "Shane", "Sean", "Andriew", "Greg", "Shida"];
const result1 = arr3.findIndex((item) => item === "Shida");
console.log(result1);
...
class Test {
  ...
  // This is private variable inside class
  #privateVariable;
...
const res1 = arr4.includes("OS");
const res2 = arr4.includes("SQL");
console.log(res1);
console.log(res2);
...
// Object keys --> It convert JSON/Map/Dictionary to array of keys
const object2 = {
  a: "somestring",
  b: 42,
  c: false,
...
const text1 = "     trim remove redundant space from starting and ending     ";
console.log(text1.trim());
const text2 =
  "        trim start will remove redundant space from starting of string";
console.log(text2.trimStart());
const text3 =
  "trim end will remove redundant space from ending of string        ";
...
const double = (x) => x * 2;
const sqr = (x) => x * x;
var output_final = compose(sqr, double)(2);
...
const obj7 = new info("Jonas", 42);
console.log(obj7);

// Promises
function success() {
  console.log("Your promise got resolved");
}
function failed() {
  console.log("Your promise got rejected");
}
